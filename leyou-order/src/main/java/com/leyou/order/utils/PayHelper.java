...
public class PayHelper {
    ...
    public String createPayUrl(Long orderId,Long actualPay, String desc) {
        ...
        try {
            ...
            if ("SUCCESS".equals(result.get("return_code"))) {  //通信表示 通信成功
    ...
    public void isValidSign(Map<String, String> data) {
        ...
        //  throw new LyException...  TODO
        // }
    }
    public void isSuccess(Map<String, String> data) {
        //校验通信成功标识，业务成功标识 TODO
    }
    ...
    public PayState queryPayState(Long orderId) {
        ...
        try {
           ...
           // 校验
            ...
            if("NOT_PAY".equals(state)||"USERPAYING".equals(state))
                return PayState.NOT_PAY;
